...
public class VentanaJuego extends JFrame {
    ...
    public void configurarActionListeners(ActionListener ataqueListener,
            ActionListener especialListener,
            ActionListener huirListener) {
        btnAtacar.addActionListener(ataqueListener);
        btnAtaqueEspecial.addActionListener(especialListener);
        btnHuir.addActionListener(huirListener);
    }

    // Método para eliminar todos los action listeners de un botón
